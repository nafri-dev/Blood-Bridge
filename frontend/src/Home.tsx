          ...
          {isMenuOpen && (
            ...
            <div className="pt-12 md:py-12 xl:container m-auto mt-12 lg:mt-28 xl:mt-28  px-6 md:px-12">
                ...
                <div className="relative lg:flex lg:items-center lg:gap-12">
                    <div className="text-center lg:text-left md:mt-12 lg:mt-0 w-full sm:w-10/12 md:w-2/3 sm:mx-auto lg:mr-auto lg:w-6/12">
                        <h1 className="text-red-600 font-black  md:font-extrabold text-3xl 400:text-4xl md:text-6xl lg:text-5xl xl:text-6xl dark:text-white  ">
                            Every two seconds someone needs <br /> <span className=" inline-block text-primary dark:text-primaryLight text-3xl 400:text-5xl xl:text-6xl mt-4 lg:mt-0">Blood🩸</span>
                        </h1>
