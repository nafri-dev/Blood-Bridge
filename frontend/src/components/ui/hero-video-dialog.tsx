...
export function HeroVideoDialog({
  ...
  return (
    <div className={cn(" flex flex-col lg:flex-row items-center justify-between gap-24", className)}>
      <div className="w-full lg:w-full relative">
        ...
        <div className="absolute -z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-full rotate-45 bg-gradient-to-r from-red-500 to-red-200 blur-3xl opacity-30 dark:opacity-20"></div>
      </div>
