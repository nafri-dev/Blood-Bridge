        ...
        <div className="container mx-auto px-6 md:px-12">
          <div className="flex items-center justify-between py-4">
            ...
            <div className="hidden lg:flex lg:items-center lg:space-x-8">
              ...
              <Link to="#emergency" className="bg-red-500 text-white px-4 py-2 rounded-full hover:bg-red-600 dark:hover:bg-red-700 transition font-medium">
                Emergency Request
              </Link>
          ...
          {/* Mobile Menu */}
          {isMenuOpen && (
            <div className="lg:hidden space-y-8 mb-12 mt-4 p-10 bg-white dark:bg-gray-900 shadow-md rounded-lg">
              <Link to="/" className="block text-center text-gray-700 dark:text-gray-300 hover:text-red-500 dark:hover:text-red-400 font-medium transition">Home</Link>
              <Link to="/donate" className="block text-center text-gray-700 dark:text-gray-300 hover:text-red-500 dark:hover:text-red-400 font-medium transition">Donate</Link>
              <Link to="/request" className="block text-center text-gray-700 dark:text-gray-300 hover:text-red-500 dark:hover:text-red-400 font-medium transition">Request</Link>
              <Link to="#emergency" className="block text-center bg-red-500 text-white px-4 py-2 rounded-full hover:bg-red-600 dark:hover:bg-red-700 transition font-medium">
                Emergency Request
              </Link>
              <Link to="/dashboard" className="flex items-center justify-center text-gray-700 dark:text-gray-300 hover:text-red-500 dark:hover:text-red-400 transition">
